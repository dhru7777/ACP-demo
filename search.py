...
from catalog import CATALOG, get_catalog_summary
...
# Singleton used by seller_agent.py
# Swap the class here to change the backend:
#   catalog_search = PineconeSearch(CATALOG)   ← Phase 4
#   catalog_search = MCPSearch(CATALOG)         ← Phase 5
